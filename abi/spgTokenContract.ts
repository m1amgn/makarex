export const spgTokenContractAbi = [
    {
        "inputs": [
            {
    ...
    {
        "inputs": [],
        "name": "SPGNFT__CallerNotFeeRecipient",
        "type": "error"
    },
    {
        "inputs": [],
        "name": "SPGNFT__CallerNotPeripheryContract",
        "type": "error"
    },
    {
        "inputs": [],
        "name": "SPGNFT__MaxSupplyReached",
        "type": "error"
    },
    {
        "inputs": [],
        "name": "SPGNFT__MintingClosed",
        "type": "error"
    },
    {
        "inputs": [],
        "name": "SPGNFT__MintingDenied",
        "type": "error"
    },
    {
        "inputs": [],
        "name": "SPGNFT__ZeroAddressParam",
        "type": "error"
    },
    {
        "inputs": [],
        "name": "SPGNFT__ZeroMaxSupply",
        "type": "error"
    },
    {
        "anonymous": false,
